...
var $author$project$Research$exposition = function () {
...
var $author$project$Main$decodeResearch = $elm$json$Json$Decode$list($author$project$Research$exposition);
...
var $author$project$Research$sortKeywordLst = F2(
	function (sorting, lst) {
		switch (sorting.$) {
			case 'ByUse':
				return $elm$core$List$reverse(
					A2($elm$core$List$sortBy, $author$project$Research$getCount, lst));
			case 'Alphabetical':
				return A2($elm$core$List$sortBy, $author$project$Research$kwName, lst);
			default:
				return A2($author$project$Research$shuffleWithSeed, 42, lst);
		}
	});
var $author$project$Main$searchKeywords = F3(
	function (q, sorting, lst) {
		var wait = $elm$core$Process$sleep(1);
		var sort = function (ls) {
			return A2(
				$elm$core$Task$andThen,
				function (_v1) {
					return $elm$core$Task$succeed(
						A2($author$project$Research$sortKeywordLst, sorting, ls));
				},
				wait);
		};
		var filter = function (ls) {
			return A2(
				$elm$core$Task$andThen,
				function (_v0) {
					return $elm$core$Task$succeed(
		...
		return A2(
			$elm$core$Task$perform,
			$author$project$Main$FoundKeywords,
			A2(
				$elm$core$Task$andThen,
				sort,
				A2(
						...
						if (_v0.b.a === 'search') {
							...
							var cmd = function () {
								if (q === '') {
									...
									var someQ = q;
									return A3(
										$author$project$Main$searchKeywords,
										someQ,
										sorting,
										$author$project$Research$toList(model.keywords));
								}
							}();
							return _Utils_Tuple2(
								_Utils_update(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$text('random'),
					url: '/#/screenshots?sorting=random'
				}),
				A2(
				$mdgriffith$elm_ui$Element$link,
				A2(
				...
				{
					label: $mdgriffith$elm_ui$Element$text('old first'),
					url: '/#/screenshots?sorting=oldestfirst'
				}),
				A2(
				$mdgriffith$elm_ui$Element$link,
				A2(
				...
				{
					label: $mdgriffith$elm_ui$Element$text('new first'),
					url: '/#/screenshots?sorting=newestfirst'
				})
			]));
};
		...
		_List_fromArray(
			[
					...
					$author$project$Main$SmallLink),
				{
					...
					url: '/#/keywords?sorting=Alphabetical'
				}),
				A2(
				$mdgriffith$elm_ui$Element$link,
				A2(
				...
				{
					label: $mdgriffith$elm_ui$Element$text('random'),
					url: '/#/keywords?sorting=Random'
				})
			]));
};
var $author$project$Research$totalNumber = function (_v0) {
	var set = _v0.a;
...
var $author$project$Main$viewKeywords = F2(
	function (model, sorting) {
		var sorted = A2(
			$author$project$Research$sortKeywordLst,
			sorting,
			$author$project$Research$toList(model.keywords));
		var lazyf = F5(
			function (all, result, kwcount, date, searchbox) {
				return A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
		...
		var keywordCount = function () {
			var count = $elm$core$String$fromInt(
				$author$project$Research$totalNumber(model.keywords)) + ' keywords';
			return A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
		...
		return A6($mdgriffith$elm_ui$Element$Lazy$lazy5, lazyf, sorted, model.search, keywordCount, lastDate, keywordSearch);
	});
