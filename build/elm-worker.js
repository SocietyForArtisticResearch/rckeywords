...
var $author$project$Queries$search = F6(
	function (title, author, keywords, after, before, portal) {
		return $author$project$Queries$Search(
			{after: after, author: author, before: before, keywords: keywords, portal: portal, title: title});
	});
var $author$project$Queries$decodeSearch = A7(
...
var $author$project$EnrichedResearch$encodeAbstractSpan = function (span) {
	if (span.$ === 'AbsKw') {
		var s = span.a;
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					't',
					$elm$json$Json$Encode$string('AbsKw')),
					_Utils_Tuple2(
					's',
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					't',
					$elm$json$Json$Encode$string('AbsText')),
					_Utils_Tuple2(
					's',
					$elm$json$Json$Encode$string(s))
				]));
...
var $author$project$EnrichedResearch$encodeAbstract = function (_abstract) {
	return A2($elm$json$Json$Encode$list, $author$project$EnrichedResearch$encodeAbstractSpan, _abstract);
};
						...
						A2(
							...
							_List_fromArray(
								[
									...
									$author$project$EnrichedResearch$encodeAbstract(exp.abstractWithKeywords))
								])))))));
};
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'expositions',
						A2($elm$json$Json$Encode$list, $author$project$EnrichedResearch$encodeResearchWithKeywords, exps))
					]));
		case 'Keywords':
			var kws = result.a;
			return $elm$json$Json$Encode$object(
...
var $author$project$Research$findResearchWithKeywords = F3(
...
var $author$project$Research$findResearchAfter = F2(
	function (date, lst) {
...
var $author$project$Research$findResearchBefore = F2(
	function (date, lst) {
		var test = function (research) {
			var _v0 = research.publication;
			if (_v0.$ === 'Just') {
...
var $author$project$Worker$searchResearch = F3(
	function (_v0, revDict, lst) {
		...
		return A3(
			...
			$author$project$Research$findResearchBefore,
			search.before,
			A3(
				$author$project$Worker$optionalFilter,
				$author$project$Research$findResearchAfter,
				search.after,
				A2(
