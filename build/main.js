...
var $author$project$Main$entry = function () {
	...
	var author = function () {
		var makeAuthor = F2(
			function (id, name) {
				return $author$project$Main$Author(
					{id: id, name: name});
			});
		return A3(
			$elm$json$Json$Decode$map2,
...
var $author$project$Main$sortingFromString = function (str) {
	switch (str) {
		case 'ByUse':
			return $author$project$Main$ByUse;
		case 'Alphabetical':
			return $author$project$Main$Alphabetical;
		case 'Random':
			return $author$project$Main$RandomKeyword;
		default:
			return $author$project$Main$ByUse;
	}
};
var $author$project$Main$handleUrl = F2(
	function (url, model) {
		var _v0 = A2($elm$core$Debug$log, 'app-url', url);
		var _v1 = url.path;
		_v1$4:
		while (true) {
			if (_v1.b) {
				if (_v1.b.b) {
					if ((_v1.a === 'keywords') && (!_v1.b.b.b)) {
						var _v2 = _v1.b;
						var keywordAsString = _v2.a;
						var _v3 = A2($author$project$Main$find, keywordAsString, model.keywords);
						if (_v3.$ === 'Just') {
							var kw = _v3.a;
							return _Utils_update(
								model,
								{
									view: $author$project$Main$KeywordsView(
										$author$project$Main$KeywordDetail(kw))
								});
						} else {
							return _Utils_update(
								model,
								{
									view: $author$project$Main$KeywordsView(
										$author$project$Main$KeywordMainView($author$project$Main$ByUse))
								});
						}
					} else {
						break _v1$4;
					...
					switch (_v1.a) {
						case 'keywords':
							var sorting = $author$project$Main$sortingFromString(
								A2(
						...
						case 'screenshots':
							var zoom = function () {
								var _v8 = A2($elm$core$Dict$get, 'zoom', url.queryParameters);
								_v8$4:
								while (true) {
									if (((_v8.$ === 'Just') && _v8.a.b) && (!_v8.a.b.b)) {
										switch (_v8.a.a) {
											case 'micro':
												var _v9 = _v8.a;
							...
							var sorting = function () {
								var _v4 = A2($elm$core$Dict$get, 'sorting', url.queryParameters);
								_v4$3:
								while (true) {
									if (((_v4.$ === 'Just') && _v4.a.b) && (!_v4.a.b.b)) {
										switch (_v4.a.a) {
											case 'random':
												var _v5 = _v4.a;
												return $author$project$Main$Random;
											case 'oldestfirst':
												var _v6 = _v4.a;
												return $author$project$Main$OldestFirst;
											case 'newestfirst':
												var _v7 = _v4.a;
												return $author$project$Main$NewestFirst;
											default:
												break _v4$3;
										}
									} else {
						...
						case 'list':
							var sorting = function () {
								var _v15 = A2($elm$core$Dict$get, 'sortby', url.queryParameters);
								_v15$3:
								while (true) {
									if (_v15.$ === 'Just') {
										if (_v15.a.b && (!_v15.a.b.b)) {
											switch (_v15.a.a) {
												case 'random':
													var _v16 = _v15.a;
													return $author$project$Main$Random;
							...
							var q = function () {
								var _v13 = A2($elm$core$Dict$get, 'q', url.queryParameters);
								if (((_v13.$ === 'Just') && _v13.a.b) && (!_v13.a.b.b)) {
									var _v14 = _v13.a;
									var qstr = _v14.a;
									return qstr;
								} else {
							...
							return _Utils_update(
								...
								{
									query: q,
									view: $author$project$Main$ListView($author$project$Main$ListViewMain)
								});
						default:
							break _v1$4;
					}
...
var $author$project$Main$urlWhereFragmentIsPath = function (url) {
	var warnMaybe = function (m) {
		if (m.$ === 'Nothing') {
			var _v1 = A2($elm$core$Debug$log, 'warning maybe detected', m);
			return m;
		} else {
			var something = m.a;
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		var _v1 = A2($elm$core$Debug$log, 'url', initUrl);
		return _Utils_Tuple2(
			A2(
				...
				initUrl,
				{
					...
					url: initUrl,
					view: $author$project$Main$KeywordsView(
						$author$project$Main$KeywordMainView($author$project$Main$RandomKeyword))
				}),
			$elm$http$Http$get(
				{
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SwitchView':
				...
				var v = function () {
					switch (str) {
						...
						case 'screenshots':
							return A2($author$project$Main$ScreenView, $author$project$Main$Medium, $author$project$Main$Random);
						default:
							return $author$project$Main$ListView($author$project$Main$ListViewMain);
					}
				}();
			...
			case 'NoScreenshot':
				var id = msg.a;
				var _v4 = A2($elm$core$Debug$log, 'no screenshot for', id);
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Main$getExposition = F2(
	function (id, model) {
...
var $author$project$Main$listView = function (model) {
	...
	var published = A2(
		$elm$core$List$filter,
		function (r) {
			return _Utils_eq(r.publicationStatus, $author$project$Main$Published);
		},
		filtered);
	return A2(
		$mdgriffith$elm_ui$Element$column,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						researchColumn(
						A2($elm$core$List$take, model.numberOfResults, published)),
						researchColumn(
						A2(
							$elm$core$List$take,
							model.numberOfResults,
							A2($elm$core$List$drop, model.numberOfResults * 2, published))),
						researchColumn(
						A2(
							$elm$core$List$take,
							model.numberOfResults,
							A2($elm$core$List$drop, model.numberOfResults * 3, published)))
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
...
var $author$project$Main$linkStyle = F2(
	function (active, style) {
		var _v0 = function () {
			if (style.$ === 'SmallLink') {
				return _Utils_Tuple2(10, 12);
			} else {
				return _Utils_Tuple2(25, 20);
			}
		}();
		var padding = _v0.a;
		var fontSize = _v0.b;
		...
		_List_fromArray(
			[
				...
				A2(
					...
					_Utils_eq(titleSorting, $author$project$Main$Random),
				...
				A2(
					$author$project$Main$linkStyle,
					_Utils_eq(titleSorting, $author$project$Main$OldestFirst),
					$author$project$Main$SmallLink),
				{
				...
				A2(
					$author$project$Main$linkStyle,
					_Utils_eq(titleSorting, $author$project$Main$NewestFirst),
					$author$project$Main$SmallLink),
				{
	...
	function (keywordset, research) {
		return $elm_community$maybe_extra$Maybe$Extra$values(
			A2(
				$elm$core$List$map,
				function (str) {
					return A2($author$project$Main$find, str, keywordset);
				},
				research.keywords));
	});
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					{
						...
						url: $lydell$elm_app_url$AppUrl$toString(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$screenViewOrderSwitch($author$project$Main$NewestFirst)
						])),
					A2(
					$mdgriffith$elm_ui$Element$link,
					_List_Nil,
					...
					A2($elm$core$List$map, $author$project$Main$viewResearch, researchWithKeyword))
				]));
	});
var $author$project$Main$ChangedQuery = function (a) {
	return {$: 'ChangedQuery', a: a};
};
var $author$project$Main$defaultPadding = A2($mdgriffith$elm_ui$Element$paddingXY, 25, 5);
...
var $author$project$Main$dateFromString = function (str) {
	...
	if (result.$ === 'Ok') {
		...
		var err = result.a;
		var _v1 = A2($elm$core$Debug$log, 'time error', err);
		return $elm$core$Maybe$Nothing;
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$author$project$Main$linkStyle,
					_Utils_eq(sorting, $author$project$Main$ByUse),
					$author$project$Main$SmallLink),
				{
				...
				A2(
					$author$project$Main$linkStyle,
					_Utils_eq(sorting, $author$project$Main$Alphabetical),
					$author$project$Main$SmallLink),
				{
				...
				A2(
					$author$project$Main$linkStyle,
					_Utils_eq(sorting, $author$project$Main$RandomKeyword),
					$author$project$Main$SmallLink),
				{
					label: $mdgriffith$elm_ui$Element$text('random'),
	...
	function (model, sorting) {
		...
		var keywordCount = function () {
			var count = 'there are: ' + ($elm$core$String$fromInt(
				$author$project$Main$totalNumber(model.keywords)) + ' keywords.');
		...
		var filtered = A2(
			...
			$author$project$Main$toList(model.keywords));
		var sorted = A2($author$project$Main$sortKeywordLst, sorting, filtered);
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$defaultPadding,
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$screenViewOrderSwitch($author$project$Main$Random)
									])),
								$author$project$Main$listView(model)
							]));
				} else {
					var id = _v0.a.a;
					var _v2 = A2($author$project$Main$getExposition, id, model);
					if (_v2.$ === 'Nothing') {
						return $mdgriffith$elm_ui$Element$none;
					} else {
						var r = _v2.a;
						return $author$project$Main$viewResearch(r);
					}
				}
			case 'KeywordsView':
				var kwtype = _v0.a;
				if (kwtype.$ === 'KeywordMainView') {
					...
					var k = kwtype.a;
					return A2($author$project$Main$viewKeywordDetail, k, model);
				}
			default:
				var scale = _v0.a;
				var sorting = _v0.b;
			...
			[
				...
				_List_fromArray(
					[
						...
						{bottom: 25, left: 15, right: 15, top: 10})
					]),
				A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.ExpositionID":{"args":[],"type":"Basics.Int"},"Main.Research":{"args":[],"type":"{ id : Main.ExpositionID, title : String.String, keywords : List.List String.String, created : String.String, author : Main.Author, issueId : Maybe.Maybe Basics.Int, publicationStatus : Main.PublicationStatus, publication : Maybe.Maybe String.String, thumbnail : Maybe.Maybe String.String, abstract : Maybe.Maybe String.String, defaultPage : String.String }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"GotResearch":["Result.Result Http.Error (List.List Main.Research)"],"Randomized":["List.List Main.Research"],"ChangedQuery":["String.String"],"SwitchView":["String.String"],"LoadMore":[],"NoScreenshot":["Main.ExpositionID"],"ShowKeyword":["Main.Keyword"],"ShowResearchDetail":["Main.ExpositionID"],"UrlChanged":["Url.Url"],"LinkClicked":["Browser.UrlRequest"]}},"Main.Author":{"args":[],"tags":{"Author":["{ id : Basics.Int, name : String.String }"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Main.Keyword":{"args":[],"tags":{"Keyword":["{ count : Basics.Int, name : String.String }"]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Main.PublicationStatus":{"args":[],"tags":{"InProgress":[],"Published":[],"LocalPublication":[],"Undecided":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));