...
var $author$project$Main$emptyForm = {author: '', keywords: _List_Nil, title: ''};
		...
		_List_fromArray(
			[
				...
				$elm$json$Json$Encode$int(
					$elm$time$Time$posixToMillis(data.after))),
				_Utils_Tuple2(
				'before',
				$elm$json$Json$Encode$int(
					$elm$time$Time$posixToMillis(data.before)))
			]));
};
...
var $author$project$Main$formWith = F3(
	function (title, author, keywords) {
		return {author: author, keywords: keywords, title: title};
	});
											...
											_Utils_update(
												model,
												{
													view: A4(
														...
														A3($author$project$Main$formWith, title, author, keywords),
														sorting,
														$author$project$Main$Page(page))
												}),
											cmd);
									case 'screen':
										var _v5 = _v0.b;
			...
			_Utils_update(
				model,
				{
					view: A4(
						$author$project$Main$SearchView,
						$author$project$Main$ListLayout,
						A3($author$project$Main$formWith, '', '', _List_Nil),
						$author$project$Research$NewestFirst,
		...
		var appurl = function () {
			if (layout.$ === 'ListLayout') {
				return A2(
					...
					_List_fromArray(
						[
							_Utils_Tuple2('keyword', searchFormState.keywords),
							_Utils_Tuple2(
							'title',
							_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$text('browse by keyword'),
					url: '/#/keywords'
				}),
				A2(
				$mdgriffith$elm_ui$Element$link,
				...
				$lydell$elm_app_url$AppUrl$toString(
					A2(
						...
						A2(
							...
							_Utils_Tuple2(
								'scale',
								$author$project$Main$scaleToString(s)),
							$lydell$elm_app_url$AppUrl$fromPath(
								_List_fromArray(
									['research', 'search', 'screen']))))));
		};
									...
									return function (_v0) {
													...
													return $author$project$Main$prefixHash(
														$lydell$elm_app_url$AppUrl$toString(
															A2(
																...
																_List_fromArray(
																	[
																		_Utils_Tuple2('keywords', initialForm.keywords),
																		_Utils_Tuple2(
																		'sorting',
																		_List_fromArray(
																			[
										...
										var render = function () {
											if (layout.$ === 'ListLayout') {
												...
												var scale = layout.a;
												return A4($author$project$Main$viewScreenshots, initialForm.keywords, dimensions, scale, sorted);
											}
										}();
	...
	var body = function () {
		...
		if (_v0.$ === 'KeywordsView') {
			...
			switch (_v1.$) {
				case 'FoundResearch':
					var lst = _v1.a;
					var _v2 = A2($elm$core$Debug$log, 'found research', lst);
				...
				case 'FoundKeywords':
					return $mdgriffith$elm_ui$Element$text('hmm, found keywords');
				case 'Searching':
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Form.Msg":{"args":["msg"],"type":"Internal.FieldEvent.Msg msg"},"Main.SearchForm":{"args":[],"type":"{ title : String.String, author : String.String, keywords : List.List String.String }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"Internal.FieldEvent.FieldEvent":{"args":[],"type":"{ value : String.String, formId : String.String, name : String.String, event : Internal.FieldEvent.Event }"},"Internal.FieldEvent.FormData":{"args":[],"type":"{ fields : Maybe.Maybe (List.List ( String.String, String.String )), method : Internal.FieldEvent.Method, action : String.String, id : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ChangedQuery":["String.String"],"UrlChanged":["Url.Url"],"LinkClicked":["Browser.UrlRequest"],"ReceiveResults":["Json.Decode.Value"],"HitEnter":[],"NoOp":[],"LoadMore":[],"AddKeyword":["String.String"],"RemoveKeyword":["String.String"],"FormMsg":["Form.Msg Main.Msg"],"SubmitSearch":["Form.Validated String.String Main.SearchForm"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Internal.FieldEvent.Msg":{"args":["msg"],"tags":{"Submit":["Internal.FieldEvent.FormData","Maybe.Maybe msg"],"FormFieldEvent":["Internal.FieldEvent.FieldEvent"],"UserMsg":["msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Form.Validated":{"args":["error","value"],"tags":{"Valid":["value"],"Invalid":["Maybe.Maybe value","Dict.Dict String.String (List.List error)"]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Internal.FieldEvent.Event":{"args":[],"tags":{"InputEvent":["String.String"],"FocusEvent":[],"BlurEvent":[]}},"Internal.FieldEvent.Method":{"args":[],"tags":{"Get":[],"Post":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));