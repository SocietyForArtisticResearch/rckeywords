									...
									return function (_abstract) {
										return function (defaultPage) {
											return function (portals) {
												return {_abstract: _abstract, author: author, created: created, defaultPage: defaultPage, id: id, issueId: issueId, keywords: keywords, portals: portals, publication: publication, publicationStatus: publicationStatus, thumbnail: thumbnail, title: title};
											};
										};
									};
								};
		...
		$elm$http$Http$get(
			{
				expect: A2(
					...
					$elm$json$Json$Decode$list($author$project$Research$decoder)),
