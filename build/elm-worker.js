...
var $author$project$Queries$search = F5(
	function (title, author, keywords, after, before) {
		return $author$project$Queries$Search(
			{after: after, author: author, before: before, keywords: keywords, title: title});
	});
var $author$project$Queries$decodeSearch = A6(
