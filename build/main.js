...
var $author$project$Main$pageSize = 16;
...
var $author$project$Main$viewResearchMicro = F4(
	function (allKeywords, screen, device, research) {
		...
		var _abstract = $author$project$EnrichedResearch$renderAbstract(research.abstractWithKeywords);
		var _v0 = function () {
			switch (device.$) {
				case 'Phone':
					return _Utils_Tuple2(screen.w - 30, screen.w);
				case 'Desktop':
					return _Utils_Tuple2(((screen.w / 3) | 0) - 30, (screen.w / 4) | 0);
				default:
		...
		var expositions = function () {
			...
			if (_v1.$ === 'ListLayout') {
				...
				return A3(
					...
					A2(
						$elm$core$List$map,
						A3($author$project$Main$viewResearchMicro, allKeywords, dimensions, device),
						sorted));
			} else {
				var scale = _v1.a;
