...
var $author$project$Main$classifyDevice = function (_v0) {
	var w = _v0.w;
	var h = _v0.h;
	return (w <= 450) ? $author$project$Main$Phone : ((w <= 1110) ? $author$project$Main$Tablet : $author$project$Main$Desktop);
};
var $author$project$Main$emptyForm = {after: $elm$core$Maybe$Nothing, author: '', before: $elm$core$Maybe$Nothing, keywords: _List_Nil, portal: '', title: ''};
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		var initView = $author$project$Main$SearchView(
			{
				form: $author$project$Main$emptyForm,
				layout: $author$project$Main$ScreenLayout($author$project$Main$Medium),
	...
	var appurl = function () {
		...
		if (_v0.$ === 'ListLayout') {
			return A2(
				...
				_List_fromArray(
					[
						_Utils_Tuple2('keyword', sv.form.keywords),
						_Utils_Tuple2(
						'title',
						_List_fromArray(
							[sv.form.title])),
						...
						_List_fromArray(
							[
								$author$project$Research$titleSortingToString(sv.sorting)
							])),
						_Utils_Tuple2(
						'page',
						_List_fromArray(
						...
						$author$project$Main$maybeToList(
							A2($elm$core$Maybe$map, $author$project$Main$dateToString, sv.form.after))),
						_Utils_Tuple2(
						'before',
						$author$project$Main$maybeToList(
							A2($elm$core$Maybe$map, $author$project$Main$dateToString, sv.form.before)))
					]),
				$lydell$elm_app_url$AppUrl$fromPath(
					_List_fromArray(
...
var $author$project$EnrichedResearch$AbsKw = function (a) {
	return {$: 'AbsKw', a: a};
};
var $author$project$EnrichedResearch$AbsText = function (a) {
	return {$: 'AbsText', a: a};
};
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$EnrichedResearch$decodeAbstractSpan = A2(
	...
	function (t) {
		switch (t) {
			case 'AbsKw':
				return A2(
					$elm$json$Json$Decode$map,
					$author$project$EnrichedResearch$AbsKw,
					A2($elm$json$Json$Decode$field, 's', $elm$json$Json$Decode$string));
			case 'AbsText':
				return A2(
					$elm$json$Json$Decode$map,
					$author$project$EnrichedResearch$AbsText,
					A2($elm$json$Json$Decode$field, 's', $elm$json$Json$Decode$string));
			default:
				return $elm$json$Json$Decode$fail('abstract decoder expected a AbsKw or AbsText');
		}
	},
	A2($elm$json$Json$Decode$field, 't', $elm$json$Json$Decode$string));
var $author$project$EnrichedResearch$decodeAbstractWithKeywords = $elm$json$Json$Decode$list($author$project$EnrichedResearch$decodeAbstractSpan);
...
var $author$project$Research$decodePublicationStatus = A2(
	$elm$json$Json$Decode$andThen,
	function (str) {
										...
										return function (defaultPage) {
											return function (portals) {
												return function (abstractWithKw) {
													return {_abstract: _abstract, abstractWithKeywords: abstractWithKw, author: authr, created: created, defaultPage: defaultPage, id: id, issueId: issueId, keywords: keywords, portals: portals, publication: publication, publicationStatus: publicationStatus, thumbnail: thumbnail, title: title};
												};
											};
										};
									};
...
var $author$project$WorkerTypes$decodeExposition = function () {
	...
	var _int = $elm$json$Json$Decode$int;
	var field = $elm$json$Json$Decode$field;
	var andMap = $elm_community$json_extra$Json$Decode$Extra$andMap;
	return A2(
		$elm$json$Json$Decode$andThen,
		function (typ) {
			if (typ === 'exposition') {
				return A2(
					andMap,
					A2(field, 'abstractWithKeywords', $author$project$EnrichedResearch$decodeAbstractWithKeywords),
					A2(
						andMap,
						A2(
							field,
						...
						A2(
							...
							A2(
								andMap,
								A2($elm_community$json_extra$Json$Decode$Extra$optionalField, 'abstract', string),
								A2(
									andMap,
									A2($elm_community$json_extra$Json$Decode$Extra$optionalField, 'thumbnail', string),
									A2(
										andMap,
										A2(
										...
										A2(
											andMap,
											A2(field, 'status', $author$project$Research$decodePublicationStatus),
											A2(
												andMap,
												A2($elm_community$json_extra$Json$Decode$Extra$optionalField, 'issueId', _int),
												A2(
													andMap,
													A2(field, 'author', $author$project$Research$author),
													A2(
														andMap,
														A2(field, 'created', string),
														A2(
															andMap,
															A2(
																$elm$json$Json$Decode$map,
																...
																A2(
																	field,
																	'keywords',
																	$elm$json$Json$Decode$list(string))),
															A2(
																andMap,
																A2(field, 'title', string),
																A2(
																	$elm$json$Json$Decode$map,
																	$author$project$EnrichedResearch$mkResearchWithKeywords,
																	A2(field, 'id', _int))))))))))))));
			} else {
				return $elm$json$Json$Decode$fail('expected an exposition');
			}
		},
...
var $author$project$Queries$emptySearch = $author$project$Queries$Search(
	{after: $elm$core$Maybe$Nothing, author: '', before: $elm$core$Maybe$Nothing, keywords: $elm$core$Set$empty, portal: '', title: ''});
var $author$project$Main$formWith = F6(
	function (title, author, keywords, portal, after, before) {
		return {after: after, author: author, before: before, keywords: keywords, portal: portal, title: title};
	});
				...
				if (result.$ === 'Ok') {
					switch (result.a.$) {
						...
						case 'AllKeywords':
							...
							var _v5 = A2($author$project$Main$handleUrl, updModel.url, updModel);
							var m = _v5.a;
							var c = _v5.b;
							...
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Main$sendQuery(
										$author$project$Queries$encodeSearchQuery(
											A2($author$project$Queries$FindKeywords, model.query, sorting))),
										A2(
										$elm$browser$Browser$Navigation$pushUrl,
										model.key,
...
var $author$project$Main$makeNumColumns = F2(
	function (num, input) {
		var f = F3(
			function (n, inp, acc) {
				if (!inp.b) {
...
var $author$project$Main$transpose = function (listOfLists) {
	var rowsLength = function (listOfListss) {
		if (!listOfListss.b) {
			return 0;
		} else {
			var x = listOfListss.a;
...
var $author$project$Main$makeColumns = F3(
	function (n, attrs, lst) {
		var columns = $author$project$Main$transpose(
...
var $author$project$Main$pageSize = 64;
var $author$project$Main$pageOfList = F2(
	function (_v0, lst) {
		var i = _v0.a;
		var start = (i - 1) * $author$project$Main$pageSize;
		return A2(
			$elm$core$List$take,
			...
			function (lst, _v5) {
				...
				if (_Utils_cmp(total, p) > -1) {
					var pageLinks = A2(
						$elm$core$List$map,
						pageLink,
						A2($elm$core$List$range, 0, total));
					var nextLink = A2(
						$mdgriffith$elm_ui$Element$el,
						_List_Nil,
						A2(
		...
		var viewCount = function (lst) {
			...
			var showing = $elm$core$String$concat(
				_List_fromArray(
					[
						'results ',
						$elm$core$String$fromInt((p - 1) * $author$project$Main$pageSize),
						'-',
						$elm$core$String$fromInt(
						A2($elm$core$Basics$min, p * $author$project$Main$pageSize, count)),
						' (total: ',
						$elm$core$String$fromInt(count),
						')'
					]));
						...
						[
							...
							switch (result.$) {
								case 'FoundKeywords':
									...
									var currentPage = A2($author$project$Main$pageOfList, page, results);
									return A2(
										$mdgriffith$elm_ui$Element$column,
										_List_fromArray(
											[
				...
				_List_fromArray(
					[
						...
						A2(
							...
							A2($author$project$Main$linkStyle, shouldEnable, $author$project$Main$BigLink)),
						{
...
var $author$project$Main$pageNav = F5(
	function (total, v, screen, lst, _v0) {
		var p = _v0.a;
		var pageLink = function (n) {
			return A2(
				$mdgriffith$elm_ui$Element$link,
		...
		switch (sorting.$) {
			case 'OldestFirst':
				return A2(
					...
					research);
			case 'Random':
				return A2($author$project$Research$shuffleWithSeed, 42, research);
			default:
				return $elm$core$List$reverse(
					A2(
						$elm$core$List$sortBy,
			...
			_List_fromArray(
				[
					...
					A2(
						...
						$author$project$Main$SmallLink),
					{
						label: $mdgriffith$elm_ui$Element$text('newest first'),
					...
					A2(
						...
						$author$project$Main$SmallLink),
					{
						label: $mdgriffith$elm_ui$Element$text('oldest first'),
			...
			_List_fromArray(
				[
						...
						$author$project$Main$SmallLink),
					{
						...
						url: makeurl(
							$author$project$Main$ScreenLayout($author$project$Main$Medium))
					}),
					A2(
					$mdgriffith$elm_ui$Element$link,
					A2(
...
var $author$project$RCStyles$mediumFont = $mdgriffith$elm_ui$Element$Font$size(15);
...
var $author$project$EnrichedResearch$renderAbstract = function (_abstract) {
	return A2(
		...
		_Utils_ap(
			_List_fromArray(
				[
					$author$project$RCStyles$mediumFont,
					$mdgriffith$elm_ui$Element$Font$family(
					_List_fromArray(
						[$author$project$RCStyles$globalFont])),
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
	...
	function (screen, device, research) {
		...
		var _v0 = function () {
			switch (device.$) {
				...
				case 'Desktop':
					return _Utils_Tuple2(((screen.w / 4) | 0) - 50, (screen.w / 5) | 0);
				default:
					var half = ((screen.w - 30) / 3) | 0;
					...
					]),
				{
					label: A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$width(
								$mdgriffith$elm_ui$Element$px(w + 30)),
								$mdgriffith$elm_ui$Element$height(
...
var $author$project$Main$SearchForm = F6(
	function (title, author, keywords, portal, after, before) {
		return {after: after, author: author, before: before, keywords: keywords, portal: portal, title: title};
	});
var $author$project$Main$searchForm = F7(
	function (title, author, keyword1, keyword2, portal, after, before) {
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Form.Msg":{"args":["msg"],"type":"Internal.FieldEvent.Msg msg"},"Main.SearchForm":{"args":[],"type":"{ title : String.String, author : String.String, keywords : List.List String.String, portal : String.String, after : Maybe.Maybe Date.Date, before : Maybe.Maybe Date.Date }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"Internal.FieldEvent.FieldEvent":{"args":[],"type":"{ value : String.String, formId : String.String, name : String.String, event : Internal.FieldEvent.Event }"},"Internal.FieldEvent.FormData":{"args":[],"type":"{ fields : Maybe.Maybe (List.List ( String.String, String.String )), method : Internal.FieldEvent.Method, action : String.String, id : Maybe.Maybe String.String }"},"Date.RataDie":{"args":[],"type":"Basics.Int"}},"unions":{"Main.Msg":{"args":[],"tags":{"ChangedQuery":["String.String"],"UrlChanged":["Url.Url"],"LinkClicked":["Browser.UrlRequest"],"ReceiveResults":["Json.Decode.Value"],"HitEnter":[],"NoOp":[],"FormMsg":["Form.Msg Main.Msg"],"SubmitSearch":["Form.Validated String.String Main.SearchForm"],"WindowResize":["Basics.Int","Basics.Int"],"ToggleForm":[]}},"Date.Date":{"args":[],"tags":{"RD":["Date.RataDie"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Internal.FieldEvent.Msg":{"args":["msg"],"tags":{"Submit":["Internal.FieldEvent.FormData","Maybe.Maybe msg"],"FormFieldEvent":["Internal.FieldEvent.FieldEvent"],"UserMsg":["msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Form.Validated":{"args":["error","value"],"tags":{"Valid":["value"],"Invalid":["Maybe.Maybe value","Dict.Dict String.String (List.List error)"]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Internal.FieldEvent.Event":{"args":[],"tags":{"InputEvent":["String.String"],"FocusEvent":[],"BlurEvent":[]}},"Internal.FieldEvent.Method":{"args":[],"tags":{"Get":[],"Post":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));