...
var $author$project$Main$splitInColumns = F2(
	function (n, lst) {
		var size = $elm$core$List$length(lst);
		var remain = A2($elm$core$Basics$modBy, n, size);
		var distribute = F2(
			function (x, ls) {
				if (!ls.b) {
					return _List_Nil;
					...
					return _Utils_ap(
						A2(
							...
							A2($elm$core$List$take, x, ls)),
						A2($elm$core$List$drop, x, ls));
				}
			});
		var chunkSize = (size / n) | 0;
		var columnLengths = A2($elm$core$List$repeat, n, chunkSize);
		var finalLengths = A2(distribute, remain, columnLengths);
		var auxe = F2(
			function (lengths, l) {
				var _v0 = _Utils_Tuple2(l, lengths);
				if (!_v0.b.b) {
					return _List_Nil;
				} else {
					if (!_v0.a.b) {
						...
						var xs = _v0.a;
						var _v1 = _v0.b;
						var currentLength = _v1.a;
						var restLengths = _v1.b;
						return A2(
							$elm$core$List$cons,
							A2($elm$core$List$take, currentLength, xs),
							A2(
								auxe,
								restLengths,
								A2($elm$core$List$drop, currentLength, xs)));
					}
				}
			});
		return A2(auxe, finalLengths, lst);
	});
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'object-fit', 'fill'),
...
var $author$project$Main$shortAbstract = function (_abstract) {
	var _v0 = A2($elm$core$String$split, '.', _abstract);
	if (_v0.b) {
		var head = _v0.a;
		return head + '.';
	} else {
					...
					label: A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Font$typeface('PT Sans')
									])),
...
var $author$project$Main$viewList = function (model) {
	...
	var filtered = A2(
		...
		model.research);
	var cls = A2(
		$author$project$Main$splitInColumns,
		3,
		A2($elm$core$List$take, 64, filtered));
	return A2(
		...
		A2(
			...
			A2($elm$core$List$map, researchColumn, cls)));
};
