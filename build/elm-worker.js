...
var $author$project$Worker$SearchKeyword = function (a) {
	return {$: 'SearchKeyword', a: a};
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Worker$searchKeyword = _Platform_incomingPort('searchKeyword', $elm$json$Json$Decode$value);
...
var $author$project$Worker$encodeKeywords = $elm$json$Json$Encode$list($author$project$Research$encodeKeyword);
...
var $author$project$Worker$findKeywords = F2(
	function (_v0, keywords) {
		var query = _v0.a;
		var sorting = _v0.b;
					...
					if (_v5.$ === 'Ok') {
						...
						return _Utils_Tuple2(
							...
							$author$project$Worker$returnResults(
								$author$project$Worker$encodeKeywords(
									A2($author$project$Worker$findKeywords, searchQuery, lmodel.keywords))));
					} else {
						return _Utils_Tuple2(
							A2(
								$author$project$Worker$problemize,
			...
			default:
				...
				if (msg.$ === 'LoadData') {
					...
					if (res.$ === 'Ok') {
						...
						var keywords = A2($author$project$Worker$findKeywords, q, kws);
						return _Utils_Tuple2(
							$author$project$Worker$Loaded(
