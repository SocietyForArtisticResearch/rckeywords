...
var $author$project$Main$KeywordMainView = {$: 'KeywordMainView'};
			...
			if (_v1.b) {
				if (_v1.b.b) {
					...
					switch (_v1.a) {
						...
						case 'screenshots':
							var zoom = function () {
								var _v4 = A2($elm$core$Dict$get, 'zoom', url.queryParameters);
								_v4$4:
								while (true) {
							...
							return _Utils_update(
								model,
								{
									view: $author$project$Main$ScreenView(zoom)
								});
						case 'list':
							var sorting = function () {
								var _v11 = A2($elm$core$Dict$get, 'sortby', url.queryParameters);
								_v11$3:
								while (true) {
									if (_v11.$ === 'Just') {
										if (_v11.a.b && (!_v11.a.b.b)) {
											switch (_v11.a.a) {
												case 'random':
													var _v12 = _v11.a;
							...
							var q = function () {
								var _v9 = A2($elm$core$Dict$get, 'q', url.queryParameters);
								if (((_v9.$ === 'Just') && _v9.a.b) && (!_v9.a.b.b)) {
									var _v10 = _v9.a;
									var qstr = _v10.a;
									return qstr;
								} else {
				...
				switch (str) {
					case 'micro':
						return _Utils_Tuple2(
							...
							A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/screenshots?zoom=micro'));
					case 'small':
						return _Utils_Tuple2(
							_Utils_update(
								model,
							...
							A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/screenshots?zoom=small'));
					case 'medium':
						return _Utils_Tuple2(
							_Utils_update(
								model,
							...
							A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/screenshots?zoom=medium'));
					case 'large':
						return _Utils_Tuple2(
							_Utils_update(
								model,
							...
							A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/screenshots?zoom=large'));
					default:
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Main$toggleSorting = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Events$onInput($author$project$Main$SetSorting)
			]),
		_List_fromArray(
			[
				A2(
			...
			$elm$core$List$head(
				A2(
					...
					$rtfeldman$elm_iso8601_date_strings$Iso8601$fromTime(
						$author$project$Main$findLastDate(researchLst)))));
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$html(
							$author$project$Main$toggleSorting(model))),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
...
var $author$project$Main$viewList = function (model) {
	var researchInProgress = A2(
		$elm$core$List$filter,
		function (r) {
			return _Utils_eq(r.publicationStatus, $author$project$Main$InProgress);
		},
		model.research);
...
var $author$project$Main$linkStyle = function (active) {
	...
	return active ? A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Font$underline, common) : common;
};
			...
			[
				...
				_List_fromArray(
					[
						...
						{bottom: 25, left: 15, right: 15, top: 50})
					]),
				A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
