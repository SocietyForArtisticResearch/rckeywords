		...
		A3(
			...
			F2(
				function (research, acc) {
					return A3($elm$core$List$foldr, $author$project$Main$insert, acc, research.keywords);
				}),
...
var $author$project$Main$viewKeywords = function (model) {
	...
	var viewKeyword = function (_v3) {
		var kw = _v3.a;
		var pixels = (kw.count > 12) ? (12 + kw.count) : (12 + kw.count);
		return A2(
			$elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(kw.count))
						]))
				]));
	};
	var sortf = function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					A2($elm$core$Basics$composeR, viewKeyword, $mdgriffith$elm_ui$Element$html),
					keywordLst))
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.ExpositionID":{"args":[],"type":"Basics.Int"},"Main.Research":{"args":[],"type":"{ id : Main.ExpositionID, title : String.String, keywords : List.List String.String, created : String.String, author : Main.Author, issueId : Maybe.Maybe Basics.Int, publicationStatus : Main.PublicationStatus, publication : Maybe.Maybe String.String, thumbnail : Maybe.Maybe String.String, abstract : Maybe.Maybe String.String, defaultPage : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"GotResearch":["Result.Result Http.Error (List.List Main.Research)"],"Randomized":["List.List Main.Research"],"ChangedQuery":["String.String"],"SetSorting":["String.String"],"SwitchView":["String.String"],"LoadMore":[],"NoScreenshot":["Main.ExpositionID"],"ChangeScreenOrder":["String.String"],"ChangeScale":["String.String"]}},"Main.Author":{"args":[],"tags":{"Author":["{ id : Basics.Int, name : String.String }"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.PublicationStatus":{"args":[],"tags":{"InProgress":[],"Published":[],"LocalPublication":[],"Undecided":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));