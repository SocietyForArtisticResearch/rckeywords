...
var $author$project$Main$sendQuery = _Platform_outgoingPort(
	'sendQuery',
	function ($) {
		var a = $.a;
		var b = $.b;
								...
								_Utils_update(
									model,
									{
										...
										view: $author$project$Main$KeywordsView(
											$author$project$Main$KeywordMainView(sorting))
									}),
								cmd);
						} else {
							var _v3 = _v0.b;
							...
							if (_v4.$ === 'Just') {
								...
								return $author$project$Main$noCmd(
									_Utils_update(
										...
										{
											view: $author$project$Main$KeywordsView(
												$author$project$Main$KeywordMainView($author$project$Research$ByUse))
										}));
							}
						}
					} else {
			...
			case 'FoundKeywords':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							search: $author$project$Main$FoundResults(lst)
						}),
					$elm$core$Platform$Cmd$none);
			case 'LoadMore':
				return _Utils_Tuple2(
								...
								label: A2(
									...
									_List_fromArray(
										[
											...
											A3($mdgriffith$elm_ui$Element$rgb, 0.0, 0.1, 0.0)),
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$Main$BigLink),
				{
					label: $mdgriffith$elm_ui$Element$text('screenshots'),
					url: '/#/screenshots'
				}),
				A2(
				$mdgriffith$elm_ui$Element$link,
			...
			case 'KeywordsView':
				...
				if (kwtype.$ === 'KeywordMainView') {
					...
					return A2(
						...
						_List_fromArray(
							[
								A2($author$project$Main$viewKeywords, model, sorting)
							]));
				} else {
					var k = kwtype.a;
