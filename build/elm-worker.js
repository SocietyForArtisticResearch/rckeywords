(function (scope) {
    "use strict";
    function $$Record1(aI, aN, aP, aQ, I, aV, ak, a_, an, a4, a5) {
        this.aI = aI;
        this.aN = aN;
        this.aP = aP;
        this.aQ = aQ;
    ...
    $$Record1.prototype.$c = function () {
        return new $$Record1(this.aI, this.aN, this.aP, this.aQ, this.I, this.aV, this.ak, this.a_, this.an, this.a4, this.a5);
    };
    function $$Record2(aB, am) {
        this.aB = aB;
        this.
            am = am;
    }
    $$Record2.prototype.$c = function () {
        return new $$Record2(this.aB, this.am);
    };
    function $$Record3(aa, K) {
        this.aa = aa;
        this.K = K;
    }
    $$Record3.prototype.$c
        = function () {
            return new $$Record3(this.aa, this.K);
        };
    function $$Record4(ak, ad, ae, ao) {
        this.ak = ak;
        this.ad = ad;
        this.
            ae = ae;
    ...
    $$Record4.
        ...
        return new $$Record4(this.ak, this.ad, this.ae, this.ao);
    };
    function $$update__aB__am(obj, aB, am) {
        var $r = obj.$c();
        $r.aB = aB;
        $r.am = am;
        return $r;
    ...
    function _Debug_regionToString(region) {
        if (region.a2.al === region.bi.al) {
            return "on line " + region.a2.al;
        }
        return "on lines " + region.a2.al + " through " + region.bi.al;
    }
    ...
    var _Platform_worker_fn = function (impl, flagDecoder, debugMetadata, args) {
        return _Platform_initialize(flagDecoder, args, impl.c3, impl.d1, impl.dJ, function () { return function () { }; });
    ...
    var _Http_toTask_fn = function (router, toTask, request) {
        return _Scheduler_binding(function (callback) {
            ...
            try {
                xhr.open(request.dd, request.d2, true);
            }
            catch (e) {
                return done($elm$http$Http$BadUrl_(request.d2));
            }
    ...
    function _Http_configureRequest(xhr, request) {
        for (var headers = request.bp; headers.b; headers = headers.b) {
    ...
    var $author$project$Worker$Loading = { $: 0 };
    ...
    var $author$project$Research$dmyToYmd = function (dmy) {
        var parts = $elm$core$String$split_fn("/", dmy);
    ...
    var $elm$http$Http$resolve_fn = function (toResult, response) {
        switch (response.$) {
            ...
            case 3:
                ...
                return $elm$core$Result$Err($elm$http$Http$BadStatus(metadata.dD));
            default:
                var body = response.b;
    ...
    var $elm$http$Http$onEffects_fn = function (router, cmds, subs, state) {
        ...
        }, $elm$http$Http$updateReqs_fn(router, cmds, state.bS));
    ...
    var $elm$http$Http$onSelfMsg_fn = function (router, _v0, state) {
        ...
        }, $elm$core$Task$sequence($elm$core$List$filterMap_fn(A3($elm$http$Http$maybeSend, router, tracker, progress), state.b0)));
    ...
    var $elm$http$Http$cmdMap_fn = function (func, cmd) {
        if (!cmd.$) {
            ...
            return $elm$http$Http$Request({
                cp: r.cp,
                cx: r.cx,
                cT: _Http_mapExpect_fn(func, r.cT),
                bp: r.bp,
                dd: r.dd,
                dY: r.dY,
                b2: r.b2,
    ...
    var $elm$http$Http$request = function (r) {
        return $elm$http$Http$command($elm$http$Http$Request({ cp: false, cx: r.cx, cT: r.cT, bp: r.bp, dd: r.dd, dY: r.dY, b2: r.b2, d2: r.d2 }));
    };
    var $elm$http$Http$get = function (r) {
        return $elm$http$Http$request({ cx: $elm$http$Http$emptyBody, cT: r.cT, bp: _List_Nil, dd: "GET", dY: $elm$core$Maybe$Nothing, b2: $elm$core$Maybe$Nothing, d2: r.d2 });
    };
    var $author$project$Worker$init = function (_v0) {
        return _Utils_Tuple2($author$project$Worker$Loading, $elm$http$Http$get({
            cT: $elm$http$Http$expectJson_fn($author$project$Worker$LoadData, $elm$json$Json$Decode$list($author$project$Research$decoder)),
            d2: "/internal_research.json"
        }));
    };
    ...
    var $author$project$Worker$DecodeError = { $: 1 };
    ...
    var $author$project$Queries$FindKeywords_fn = function (a, b) {
        return { $: 0, a: a, b: b };
    }, $author$project$Queries$FindKeywords = F2($author$project$Queries$FindKeywords_fn);
    ...
    var $author$project$Queries$decodeKeywordSorting = _Json_andThen_fn(function (s) {
        switch (s) {
            case "ByUse":
    ...
    var $author$project$Queries$decodeSearchQuery = _Json_andThen_fn(function (t) {
        switch (t) {
            case "FindKeywords":
                return _Json_map2_fn($author$project$Queries$FindKeywords, _Json_decodeField_fn("keywords", $elm$json$Json$Decode$string), _Json_decodeField_fn("sorting", $author$project$Queries$decodeKeywordSorting));
            case "FindResearch":
                return _Json_map1_fn($author$project$Queries$FindResearch, _Json_decodeField_fn("keywords", $elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
            default:
                return $elm$json$Json$Decode$fail("Unknown query type");
        }
    }, _Json_decodeField_fn("type", $elm$json$Json$Decode$string));
    ...
    var $author$project$Research$encodeAuthor = function (au) {
        return $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2("name", $elm$json$Json$Encode$string($author$project$Research$getName(au))),
            _Utils_Tuple2("id", $elm$json$Json$Encode$int($author$project$Research$getAuthorId(au)))
        ]));
    };
    ...
    var $author$project$Research$encodeExposition = function (exp) {
        ...
        var thumbnail = $elm$core$Maybe$map_fn(function (t) {
            return _Utils_Tuple2("thumbnail", string(t));
        }, exp.a4);
        var publication = $elm$core$Maybe$map_fn(function (p) {
            return _Utils_Tuple2("publication", string(p));
        }, exp.a_);
        var maybeAppend = F2(function (x, xs) {
            if (!x.$) {
                var v = x.a;
                return _List_Cons(v, xs);
            }
            else {
                return xs;
            }
        ...
        var issueId = $elm$core$Maybe$map_fn(function (id) {
            return _Utils_Tuple2("id", _int(id));
        }, exp.aV);
        var _abstract = $elm$core$Maybe$map_fn(function (a) {
            return _Utils_Tuple2("abstract", string(a));
        }, exp.aI);
        return $elm$json$Json$Encode$object(A2(maybeAppend, _abstract, A2(maybeAppend, thumbnail, A2(maybeAppend, publication, A2(maybeAppend, issueId, _List_fromArray([
            _Utils_Tuple2("type", string("exposition")),
            _Utils_Tuple2("id", _int(exp.I)),
            _Utils_Tuple2("created", string(exp.aP)),
            _Utils_Tuple2("title", string(exp.a5)),
            _Utils_Tuple2("keywords", A2(list, string, exp.ak)),
            _Utils_Tuple2("author", $author$project$Research$encodeAuthor(exp.aN)),
            _Utils_Tuple2("publicationStatus", $author$project$Research$publicationstatus(exp.an)),
            _Utils_Tuple2("defaultPage", string(exp.aQ))
        ]))))));
    };
    var $author$project$Research$encodeKeyword = function (_v0) {
        var kw = _v0;
        return $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2("type", $elm$json$Json$Encode$string("keyword")),
            _Utils_Tuple2("count", $elm$json$Json$Encode$int(kw.aa)),
            _Utils_Tuple2("name", $elm$json$Json$Encode$string(kw.K))
        ]));
    };
    var $author$project$Queries$encodeSearchResult = function (result) {
        if (!result.$) {
            var exps = result.a;
            return $elm$json$Json$Encode$object(_List_fromArray([
                _Utils_Tuple2("type", $elm$json$Json$Encode$string("expositions")),
                _Utils_Tuple2("expositions", $elm$json$Json$Encode$list_fn($author$project$Research$encodeExposition, exps))
            ]));
        }
        else {
            var kws = result.a;
            return $elm$json$Json$Encode$object(_List_fromArray([
                _Utils_Tuple2("type", $elm$json$Json$Encode$string("keywords")),
                _Utils_Tuple2("keywords", $elm$json$Json$Encode$list_fn($author$project$Research$encodeKeyword, kws))
            ]));
        }
    };
    ...
    var $author$project$Worker$findKeywords_fn = function (query, sorting, keywords) {
        ...
        var filtered = function () {
            if (query === "") {
                ...
                var nonEmptyQ = query;
                return $elm$core$List$filter_fn(A2($elm$core$Basics$composeR, $author$project$Research$kwName, A2($elm$core$Basics$composeR, $elm$core$String$toLower, $elm$core$String$contains($elm$core$String$toLower(nonEmptyQ)))), lst);
            }
        }();
        switch (sorting) {
            case 0:
    ...
    var $elm$core$Dict$intersect_fn = function (t1, t2) {
        return $elm$core$Dict$filter_fn_unwrapped(function (k, _v0) {
            return $elm$core$Dict$member_fn(k, t2);
        }, t1);
    }, $elm$core$Dict$intersect = F2($elm$core$Dict$intersect_fn);
    var $elm$core$Set$intersect_fn = function (_v0, _v1) {
        var dict1 = _v0;
        var dict2 = _v1;
        return $elm$core$Dict$intersect_fn(dict1, dict2);
    }, $elm$core$Set$intersect = F2($elm$core$Set$intersect_fn);
    ...
    var $author$project$Research$findResearchWithKeywords_fn = function (kw, dict, research) {
        var intersectionOfNonempty = F2(function (first, rest) {
            return $elm$core$Set$toList($elm$core$List$foldl_fn($elm$core$Set$intersect, first, rest));
        });
        var getId = function (exp) {
            return exp.I;
        };
        var findKw = function (k) {
            return $elm$core$Maybe$withDefault_fn(_List_Nil, function (s) {
                return $elm$core$Dict$get_fn(s, dict);
            }(k));
        };
        ...
        if (!kw.b) {
            ...
            var ids = combineResults($elm$core$List$map_fn(A2($elm$core$Basics$composeR, findKw, A2($elm$core$Basics$composeR, $elm$core$List$map(getId), $elm$core$Set$fromList)), kw));
            return $elm$core$List$filter_fn(function (exp) {
                return $elm$core$List$member_fn(exp.I, ids);
            }, research);
        }
    }, $author$project$Research$findResearchWithKeywords = F3($author$project$Research$findResearchWithKeywords_fn);
    var $author$project$Research$Keyword = $elm$core$Basics$identity;
    var $author$project$Research$newKey = function (str) {
        return (new $$Record3(1, str));
    };
    ...
    var $author$project$Research$insert_fn = function (k, _v0) {
        ...
        if (!result.$) {
            ...
            var newDict = $elm$core$Dict$insert_fn(kw.K, used, dict);
            return $$update__aB__am(set, newDict, $elm$core$Dict$values(newDict));
        }
        else {
            var _new = $author$project$Research$newKey(k);
            return $$update__aB__am(set, $elm$core$Dict$insert_fn(k, _new, dict), _List_Cons(_new, set.am));
        }
    ...
    var $author$project$Research$keywordSet = function (researchlist) {
        return $elm$core$List$foldr_fn(F2(function (research, set) {
            return $elm$core$List$foldr_fn($author$project$Research$insert, set, research.ak);
    ...
    var $author$project$Worker$problemize_fn = function (p, m) {
        switch (m.$) {
            ...
            default:
                var lm = m.a;
                return $author$project$Worker$Loaded(function () {
                    var $r = lm.$c();
                    $r.ad = _List_Cons(p, lm.ad);
                    return $r;
                }());
        }
    ...
    var $author$project$Research$reverseKeywordDict = function (research) {
        var addExpToKeyword = F3(function (xpo, kw, currentDict) {
            return $elm$core$Dict$update_fn(kw, function (value) {
                if (value.$ === 1) {
                    return $elm$core$Maybe$Just(_List_fromArray([xpo]));
                }
                else {
                    var lst = value.a;
                    return $elm$core$Maybe$Just(_List_Cons(xpo, lst));
                }
            }, currentDict);
        });
        var addResearchToDict = F2(function (exp, currentDict) {
            return $elm$core$List$foldl_fn(addExpToKeyword(exp), currentDict, exp.ak);
        });
        ...
        switch (model.$) {
            case 0:
                if (!msg.$) {
                    ...
                    if (!res.$) {
                        var data = res.a;
                        var keywordSet = $author$project$Research$keywordSet(data);
                        return _Utils_Tuple2($author$project$Worker$Loaded((new $$Record4(keywordSet, _List_Nil, data, $author$project$Research$reverseKeywordDict(data)))), $elm$core$Platform$Cmd$none);
                    }
                    else {
                        var e = res.a;
                        return _Utils_Tuple2($author$project$Worker$problemize_fn($author$project$Worker$LoadError(e), model), $elm$core$Platform$Cmd$none);
                    }
                }
                else {
                    var json = msg.a;
                    var _v3 = _Json_run_fn($author$project$Queries$decodeSearchQuery, json);
                    if (!_v3.$) {
                        var query = _v3.a;
                        return _Utils_Tuple2($author$project$Worker$LoadingWithQuery(query), $elm$core$Platform$Cmd$none);
                    }
                    else {
                        return _Utils_Tuple2($author$project$Worker$problemize_fn($author$project$Worker$DecodeError, model), $elm$core$Platform$Cmd$none);
                    }
                }
            case 2:
                var lmodel = model.a;
                if (msg.$ === 1) {
                    var json = msg.a;
                    var _v5 = _Json_run_fn($author$project$Queries$decodeSearchQuery, json);
                    if (!_v5.$) {
                        var q = _v5.a;
                        if (!q.$) {
                            var str = q.a;
                            var kwSorting = q.b;
                            return _Utils_Tuple2($author$project$Worker$Loaded(lmodel), $author$project$Worker$returnResults($author$project$Queries$encodeSearchResult($author$project$Queries$Keywords($author$project$Worker$findKeywords_fn(str, kwSorting, lmodel.ak)))));
                        }
                        else {
                            var kws = q.a;
                            return _Utils_Tuple2($author$project$Worker$Loaded(lmodel), $author$project$Worker$returnResults($author$project$Queries$encodeSearchResult($author$project$Queries$Expositions($author$project$Research$findResearchWithKeywords_fn(kws, lmodel.ao, lmodel.ae)))));
                        }
                    }
                    else {
                        return _Utils_Tuple2($author$project$Worker$problemize_fn($author$project$Worker$DecodeError, $author$project$Worker$Loaded(lmodel)), $elm$core$Platform$Cmd$none);
                    }
                }
                else {
                    var res = msg.a;
                    if (!res.$) {
                        var data = res.a;
                        return _Utils_Tuple2($author$project$Worker$Loaded(function () {
                            var $r = lmodel.$c();
                            $r.ae = data;
                            $r.ak = $author$project$Research$keywordSet(data);
                            return $r;
                        }()), $elm$core$Platform$Cmd$none);
                    }
                    else {
                        var e = res.a;
                        return _Utils_Tuple2($author$project$Worker$problemize_fn($author$project$Worker$LoadError(e), $author$project$Worker$Loaded(lmodel)), $elm$core$Platform$Cmd$none);
                    }
                }
            default:
                var q = model.a;
                    ...
                    if (!res.$) {
                        ...
                        var cmd = function () {
                            if (!q.$) {
                                var str = q.a;
                                var kwsorting = q.b;
                                return $author$project$Worker$returnResults($author$project$Queries$encodeSearchResult($author$project$Queries$Keywords($author$project$Worker$findKeywords_fn(str, kwsorting, kws))));
                            }
                            else {
                                var keywords = q.a;
                                return $author$project$Worker$returnResults($author$project$Queries$encodeSearchResult($author$project$Queries$Expositions($author$project$Research$findResearchWithKeywords_fn(keywords, reverseKeywordDict, data))));
                            }
                        }();
                        return _Utils_Tuple2($author$project$Worker$Loaded((new $$Record4(kws, _List_Nil, data, reverseKeywordDict))), cmd);
                    }
                    else {
                        var e = res.a;
                        return _Utils_Tuple2($author$project$Worker$problemize_fn($author$project$Worker$LoadError(e), $author$project$Worker$Loaded((new $$Record4($author$project$Research$emptyKeywordSet, _List_Nil, _List_Nil, $author$project$Research$reverseKeywordDict(_List_Nil))))), $elm$core$Platform$Cmd$none);
                    }
                }
                else {
                    var json = msg.a;
                    var _v11 = _Json_run_fn($author$project$Queries$decodeSearchQuery, json);
                    if (!_v11.$) {
                        var query = _v11.a;
                        return _Utils_Tuple2($author$project$Worker$LoadingWithQuery(query), $elm$core$Platform$Cmd$none);
                    }
    ...
    var $author$project$Worker$main_a0 = { c3: $author$project$Worker$init, dJ: $author$project$Worker$subscriptions, d1: $author$project$Worker$update }, $author$project$Worker$main = $elm$core$Platform$worker($author$project$Worker$main_a0);
