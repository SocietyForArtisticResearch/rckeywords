...
var $author$project$Main$Research = F8(
	function (id, title, keywords, created, author, issueId, publicationStatus, publication) {
		return {author: author, created: created, id: id, issueId: issueId, keywords: keywords, publication: publication, publicationStatus: publicationStatus, title: title};
	});
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		...
		$elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Main$GotResearch, $author$project$Main$decodeResearch),
				url: 'research.json'
			}));
};
var $author$project$Main$KeywordGraphMsg = function (a) {
	return {$: 'KeywordGraphMsg', a: a};
};
var $elm$core$Platform$Sub$map = _Platform_map;
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$KeywordGraph$DragAt = function (a) {
	return {$: 'DragAt', a: a};
};
var $author$project$KeywordGraph$DragEnd = function (a) {
	return {$: 'DragEnd', a: a};
};
var $author$project$KeywordGraph$Resize = F2(
	function (a, b) {
		return {$: 'Resize', a: a, b: b};
	});
var $author$project$KeywordGraph$Tick = function (a) {
	return {$: 'Tick', a: a};
};
var $author$project$KeywordGraph$ZoomMsg = function (a) {
	return {$: 'ZoomMsg', a: a};
};
...
var $author$project$KeywordGraph$subscriptions = function (model) {
			...
			[
				...
				A2(
					...
					A2(
						...
						$author$project$KeywordGraph$DragAt),
				...
				A2(
					...
					A2(
						...
						$author$project$KeywordGraph$DragEnd),
					$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$eventDecoder)),
				$elm$browser$Browser$Events$onAnimationFrame($author$project$KeywordGraph$Tick)
			]));
	var readySubscriptions = function (_v2) {
		var drag = _v2.drag;
		var simulation = _v2.simulation;
		var zoom = _v2.zoom;
		return $elm$core$Platform$Sub$batch(
			_List_fromArray(
				[
					A2($gampleman$elm_visualization$Zoom$subscriptions, zoom, $author$project$KeywordGraph$ZoomMsg),
					function () {
					if (drag.$ === 'Nothing') {
						return $gampleman$elm_visualization$Force$isCompleted(simulation) ? $elm$core$Platform$Sub$none : $elm$browser$Browser$Events$onAnimationFrame($author$project$KeywordGraph$Tick);
					} else {
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$elm$browser$Browser$Events$onResize($author$project$KeywordGraph$Resize)
			]));
};
var $author$project$Main$subscriptions = function (m) {
	if (m.$ === 'Waiting') {
		...
		return A2(
			...
			$author$project$Main$KeywordGraphMsg,
			$author$project$KeywordGraph$subscriptions(model.keywordGraph));
	}
};
...
var $author$project$Main$getId = function (_v0) {
	var id = _v0.a.id;
	return id;
};
var $author$project$Main$lookupString = F2(
	function (str, _v0) {
		var dict = _v0.a.dict;
		return A2($elm$core$Dict$get, str, dict);
	});
var $author$project$Main$onlyTheJusts = function (listOfM) {
	return A3(
		$elm$core$List$foldr,
		F2(
			function (mx, acc) {
...
var $author$project$Main$fetchReferencesIds = F2(
	function (kwSet, _v0) {
		var refs = _v0.a.refs;
		return A2(
			$elm$core$List$concatMap,
			function (research) {
				return $author$project$Main$onlyTheJusts(
					A2(
						$elm$core$List$map,
						function (str) {
							return A2(
								$elm$core$Maybe$map,
								$author$project$Main$getId,
								A2($author$project$Main$lookupString, str, kwSet));
						},
						research.keywords));
			},
			refs);
	});
var $author$project$Main$toInt = function (_v0) {
	var id = _v0.a;
	return id;
};
var $author$project$Main$edgesFromKeyword = F2(
	function (kwSet, _v0) {
		var k = _v0.a;
		var toIds = A2(
			$elm$core$List$map,
			...
			A2(
				$author$project$Main$fetchReferencesIds,
				kwSet,
				$author$project$Main$Keyword(k)));
		var fromId = $author$project$Main$toInt(k.id);
		return A2(
			$elm$core$List$map,
			function (toId) {
				return _Utils_Tuple2(fromId, toId);
			},
			toIds);
	});
...
var $author$project$Main$setKeywordId = F2(
	function (id, _v0) {
		var k = _v0.a;
		return $author$project$Main$Keyword(
			_Utils_update(
				k,
				{
					id: $author$project$Main$Id(id)
				}));
	});
var $author$project$Main$graphFromKeyword = F3(
	function (depth, kw, set) {
		var insertStringUnique = F2(
			function (str, lst) {
				return (!A2($elm$core$List$member, str, lst)) ? A2($elm$core$List$cons, str, lst) : lst;
			});
		var refsFromKeyword = function (_v1) {
			var keyword = _v1.a;
			return $author$project$Main$onlyTheJusts(
				A2(
					$elm$core$List$concatMap,
					function (research) {
						return A2(
							$elm$core$List$map,
							A2($author$project$Main$flip, $author$project$Main$lookupString, set),
							A3($elm$core$List$foldl, insertStringUnique, _List_Nil, research.keywords));
					},
					keyword.refs));
		};
		var helper = F2(
				...
				while (true) {
					if (n <= 0) {
						...
						var $temp$n = n - 1,
							...
							_List_Nil,
							A2($elm$core$List$concatMap, refsFromKeyword, lst));
						n = $temp$n;
						lst = $temp$lst;
						continue helper;
					}
		...
		var limitedLst = A2(
			...
			_List_fromArray(
				[kw]));
		var labels = A2($elm$core$List$map, $author$project$Main$getName, limitedLst);
		var edges = A2(
			$elm$core$List$concatMap,
			$author$project$Main$edgesFromKeyword(set),
			A2($elm$core$List$indexedMap, $author$project$Main$setKeywordId, limitedLst));
		var _v0 = A2(
			$elm$core$Debug$log,
			'edges are ' + $author$project$Main$getName(kw),
			edges);
		return A2($elm_community$graph$Graph$fromNodeLabelsAndEdgePairs, labels, edges);
	});
var $author$project$KeywordGraph$Init = function (a) {
	return {$: 'Init', a: a};
};
var $author$project$KeywordGraph$ReceiveElementPosition = function (a) {
	return {$: 'ReceiveElementPosition', a: a};
};
...
var $author$project$KeywordGraph$elementId = 'exercise-graph';
var $elm$browser$Browser$Dom$getElement = _Browser_getElement;
var $author$project$KeywordGraph$getElementPosition = A2(
	$elm$core$Task$attempt,
	$author$project$KeywordGraph$ReceiveElementPosition,
	$elm$browser$Browser$Dom$getElement($author$project$KeywordGraph$elementId));
...
var $author$project$KeywordGraph$initNode = function (ctx) {
	return {
...
var $author$project$KeywordGraph$init = function (grph) {
	var graph = A2($elm_community$graph$Graph$mapContexts, $author$project$KeywordGraph$initNode, grph);
	return _Utils_Tuple2(
		$author$project$KeywordGraph$Init(graph),
		$author$project$KeywordGraph$getElementPosition);
};
...
var $author$project$Main$hide = function (_v0) {
	var k = _v0.a;
	return $author$project$Main$Keyword(
		_Utils_update(
			k,
			{display: $author$project$Main$Hide}));
};
...
var $author$project$Main$toggle = function (_v0) {
	var k = _v0.a;
	return $author$project$Main$Keyword(
		_Utils_update(
			k,
...
var $author$project$Main$showInSet = F2(
	function (key, _v0) {
		var set = _v0.a;
		var newSet = A2(
			$elm$core$Dict$map,
			F2(
				function (k, v) {
					return _Utils_eq(k, key) ? $author$project$Main$toggle(v) : $author$project$Main$hide(v);
				}),
			set.dict);
...
var $author$project$KeywordGraph$Ready = function (a) {
	return {$: 'Ready', a: a};
};
...
var $author$project$KeywordGraph$shiftPosition = F3(
...
var $author$project$KeywordGraph$updateContextWithValue = F2(
...
var $author$project$KeywordGraph$updateNode = F2(
	function (_v0, nodeCtx) {
		var x = _v0.a;
		var y = _v0.b;
		var nodeValue = nodeCtx.node.label;
		return A2(
			$author$project$KeywordGraph$updateContextWithValue,
			nodeCtx,
			_Utils_update(
				nodeValue,
				{x: x, y: y}));
	});
var $author$project$KeywordGraph$updateNodePosition = F3(
	function (index, xy, state) {
		return A3(
			$elm_community$graph$Graph$update,
			index,
			$elm$core$Maybe$map(
				$author$project$KeywordGraph$updateNode(
					A3(
						$author$project$KeywordGraph$shiftPosition,
						state.zoom,
						_Utils_Tuple2(state.element.x, state.element.y),
						xy))),
			state.graph);
	});
var $author$project$KeywordGraph$handleDragAt = F2(
	function (xy, state) {
		var drag = state.drag;
		...
		if (drag.$ === 'Just') {
			...
			return _Utils_Tuple2(
				$author$project$KeywordGraph$Ready(
					_Utils_update(
						state,
						{
							drag: $elm$core$Maybe$Just(
								{current: xy, index: index, start: start}),
							graph: A3($author$project$KeywordGraph$updateNodePosition, index, xy, state),
							simulation: $gampleman$elm_visualization$Force$reheat(simulation)
						})),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
				$author$project$KeywordGraph$Ready(state),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$KeywordGraph$updateGraphWithList = function () {
	var graphUpdater = function (value) {
		return $elm$core$Maybe$map(
			function (ctx) {
				return A2($author$project$KeywordGraph$updateContextWithValue, ctx, value);
			});
	};
...
var $author$project$KeywordGraph$handleTick = function (state) {
	var _v0 = A2(
		...
		A2(
			...
			$elm_community$graph$Graph$nodes(state.graph)));
		...
		return _Utils_Tuple2(
			$author$project$KeywordGraph$Ready(
				_Utils_update(
					state,
					{
						graph: A2($author$project$KeywordGraph$updateGraphWithList, state.graph, list),
						showGraph: true,
						simulation: newSimulation
					})),
			$elm$core$Platform$Cmd$none);
	} else {
		var current = _v1.a.current;
							...
							$elm$core$Maybe$map(
								$author$project$KeywordGraph$updateNode(
									A3(
										...
										_Utils_Tuple2(state.element.x, state.element.y),
										current))),
							A2($author$project$KeywordGraph$updateGraphWithList, state.graph, list)),
						showGraph: true,
						simulation: newSimulation
					})),
			$elm$core$Platform$Cmd$none);
...
var $author$project$KeywordGraph$initSimulation = F3(
				...
				_List_fromArray(
					[
						...
						A2(
							...
							$elm_community$graph$Graph$nodes(graph))),
						A2($gampleman$elm_visualization$Force$center, width / 2, height / 2)
					])));
	});
...
var $author$project$KeywordGraph$initZoom = function (element) {
	return A3(
...
var $author$project$KeywordGraph$update = F2(
	function (msg, model) {
		...
		switch (_v0.a.$) {
			case 'Tick':
				if (_v0.b.$ === 'Ready') {
					var state = _v0.b.a;
					return $author$project$KeywordGraph$handleTick(state);
				} else {
			...
			case 'DragAt':
				if (_v0.b.$ === 'Ready') {
					var xy = _v0.a.a;
					var state = _v0.b.a;
					return A2($author$project$KeywordGraph$handleDragAt, xy, state);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'DragEnd':
					...
					return _Utils_Tuple2(
						$author$project$KeywordGraph$Ready(
							_Utils_update(
								...
								{
									drag: $elm$core$Maybe$Just(
										{current: xy, index: index, start: xy})
								})),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v3 = _v0.a;
							...
							$author$project$KeywordGraph$Ready(
								{
									...
									graph: graph,
									showGraph: false,
									simulation: A3($author$project$KeywordGraph$initSimulation, graph, element.width, element.height),
									zoom: $author$project$KeywordGraph$initZoom(element)
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						var element = _v0.a.a.a.element;
							...
							$author$project$KeywordGraph$Ready(
								{
									...
									graph: state.graph,
									showGraph: true,
									simulation: A3($author$project$KeywordGraph$initSimulation, state.graph, element.width, element.height),
									zoom: $author$project$KeywordGraph$initZoom(element)
								}),
							$elm$core$Platform$Cmd$none);
					}
			...
			case 'Resize':
				var _v4 = _v0.a;
				return _Utils_Tuple2(model, $author$project$KeywordGraph$getElementPosition);
			default:
				if (_v0.b.$ === 'Ready') {
					var zoomMsg = _v0.a.a;
					var state = _v0.b.a;
...
var $author$project$Main$updateInitialized = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ChangedQuery':
				var q = msg.a;
			...
			case 'ClickedKeyword':
				var k = msg.a;
				var newKeywords = A2($author$project$Main$showInSet, k, model.keywordSet);
				var mGraph = A2(
					$elm$core$Maybe$map,
					function (kw) {
						return A3($author$project$Main$graphFromKeyword, 1, kw, model.keywordSet);
					},
					A2($author$project$Main$lookupString, k, model.keywordSet));
				var localGraph = function () {
					if (mGraph.$ === 'Nothing') {
						return $elm_community$graph$Graph$empty;
					} else {
						var grph = mGraph.a;
						return grph;
					}
				}();
				var _v1 = $author$project$KeywordGraph$init(localGraph);
				var gModel = _v1.a;
				var gMsg = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{keywordGraph: gModel, keywordSet: newKeywords}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$KeywordGraphMsg, gMsg));
			case 'KeywordGraphMsg':
				var kmsg = msg.a;
				var _v3 = A2($author$project$KeywordGraph$update, kmsg, model.keywordGraph);
				var kmodel = _v3.a;
				var kcmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{keywordGraph: kmodel}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$KeywordGraphMsg, kcmd));
			default:
				var _v4 = A2($elm$core$Debug$log, 'impossible msg', msg);
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$getWindowSize = function (model) {
	if (model.$ === 'Waiting') {
		...
		return initModel.windowSize;
	}
};
var $author$project$Main$emptyKeywordSet = $author$project$Main$KeywordSet(
	{
		currentId: $author$project$Main$Id(0),
		dict: $elm$core$Dict$empty
	});
var $author$project$Main$newKey = F2(
	function (id, str) {
		return $author$project$Main$Keyword(
			{
				display: $author$project$Main$Hide,
...
var $author$project$Main$use = F2(
	function (research, _v0) {
		var kw = _v0.a;
		return $author$project$Main$Keyword(
			_Utils_update(
				kw,
				{
					refs: A2($elm$core$List$cons, research, kw.refs)
				}));
	});
var $author$project$Main$insert = F3(
	function (research, k, _v0) {
		var dict = _v0.a.dict;
			...
			return $author$project$Main$KeywordSet(
				{
					...
					dict: A3(
						...
						k,
						A2(
							$author$project$Main$newKey,
							$author$project$Main$toInt(currentId),
							k),
						dict)
				});
		}
...
var $author$project$Main$keywords = function (researchlist) {
	return A3(
		$elm$core$List$foldr,
		F2(
			function (research, acc) {
				return A3(
					$elm$core$List$foldr,
					$author$project$Main$insert(research),
					acc,
					research.keywords);
			}),
...
var $author$project$Main$updateWithResult = F2(
	function (result, model) {
		var window = $author$project$Main$getWindowSize(model);
		if (result.$ === 'Ok') {
			var lst = result.a;
			var set = $author$project$Main$keywords(lst);
			var _v1 = $author$project$KeywordGraph$init($elm_community$graph$Graph$empty);
			var graphModel = _v1.a;
			var cmd = _v1.b;
			return _Utils_Tuple2(
				$author$project$Main$Ready(
					{keywordGraph: graphModel, keywordSet: set, query: '', research: lst, windowSize: window}),
				A2($elm$core$Platform$Cmd$map, $author$project$Main$KeywordGraphMsg, cmd));
		} else {
			var err = result.a;
			var _v2 = A2($elm$core$Debug$log, 'whoops, error: ', err);
			return _Utils_Tuple2(
				$author$project$Main$Waiting(window),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		if (model.$ === 'Waiting') {
			var screensize = model.a;
			if (msg.$ === 'GotResearch') {
				var result = msg.a;
				return A2($author$project$Main$updateWithResult, result, model);
			} else {
				return _Utils_Tuple2(
					$author$project$Main$Waiting(screensize),
					$elm$core$Platform$Cmd$none);
			}
		} else {
			var initializedModel = model.a;
			var _v2 = A2($author$project$Main$updateInitialized, msg, initializedModel);
			var newInitializedModel = _v2.a;
			var cmd = _v2.b;
			return _Utils_Tuple2(
				$author$project$Main$Ready(newInitializedModel),
				cmd);
		}
	});
...
var $author$project$Main$ClickedKeyword = function (a) {
	return {$: 'ClickedKeyword', a: a};
};
...
var $author$project$Main$inlineStyle = _List_fromArray(
	[
...
var $author$project$Main$searchLink = function (term) {
	return A3($elm$core$String$replace, ' ', '%20', 'https://www.researchcatalogue.net/portal/search-result?fulltext=&title=&autocomplete=&keyword=' + (term + '&portal=&statusprogress=0&statuspublished=0&includelimited=0&includeprivate=0&type_research=research&resulttype=research&format=html&limit=25&page=0'));
};
...
var $elm_community$typed_svg$TypedSvg$Types$CursorMove = {$: 'CursorMove'};
...
var $author$project$KeywordGraph$edgeColor = $elm_community$typed_svg$TypedSvg$Types$Paint(
...
var $author$project$KeywordGraph$linkElement = F2(
	function (graph, edge) {
		var target = A2(
			$elm$core$Maybe$withDefault,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Attributes$stroke($author$project$KeywordGraph$edgeColor),
...
var $author$project$KeywordGraph$DragStart = F2(
	function (a, b) {
...
var $author$project$KeywordGraph$onMouseDown = function (index) {
	return $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onDown(
		A2(
			...
			$author$project$KeywordGraph$DragStart(index)));
};
...
var $author$project$KeywordGraph$nodeElement = function (node) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$r(20),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$strokeWidth(1),
						$elm_community$typed_svg$TypedSvg$Attributes$fill(
						$elm_community$typed_svg$TypedSvg$Types$Paint($avh4$elm_color$Color$yellow)),
						...
						$author$project$KeywordGraph$onMouseDown(node.id)
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$dx(node.label.x),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$dy(node.label.y),
...
var $author$project$KeywordGraph$renderGraph = function (model) {
	if (model.$ === 'Init') {
		return $elm_community$typed_svg$TypedSvg$Core$text('');
	} else {
		var graph = model.a.graph;
		var showGraph = model.a.showGraph;
		return showGraph ? A2(
			$elm_community$typed_svg$TypedSvg$g,
			_List_Nil,
			_List_fromArray(
				[
					...
					A2(
						$elm$core$List$map,
						$author$project$KeywordGraph$linkElement(graph),
						$elm_community$graph$Graph$edges(graph))),
					A2(
					$elm_community$typed_svg$TypedSvg$g,
					_List_fromArray(
					...
					A2(
						$elm$core$List$map,
						$author$project$KeywordGraph$nodeElement,
						$elm_community$graph$Graph$nodes(graph)))
...
var $author$project$KeywordGraph$view = function (model) {
	...
	var zoomEvents = function () {
		if (model.$ === 'Init') {
			...
			var zoom = model.a.zoom;
			return A2($gampleman$elm_visualization$Zoom$events, zoom, $author$project$KeywordGraph$ZoomMsg);
		}
	}();
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'border', '2px solid rgba(0, 0, 0, 0.85)')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Attributes$id($author$project$KeywordGraph$elementId),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$KeywordGraph$renderGraph(model)
							]))
					]))
			]));
};
...
var $author$project$Main$view = function (m) {
	if (m.$ === 'Waiting') {
		...
		var model = m.a;
		var width = function (_v4) {
			var ws = _v4.a;
			return ws.width;
		}(
			$author$project$Main$getWindowSize(m));
		var viewTitle = function (r) {
			return A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
		...
		var viewKeyword = function (_v3) {
			var kw = _v3.a;
			var refs = A3(
				$elm$core$List$foldr,
				F2(
					function (r, acc) {
						return _Utils_ap(r.keywords, acc);
					}),
				_List_Nil,
				kw.refs);
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'font-size',
							$elm$core$String$fromInt(pixels) + 'px')
						]),
					_List_fromArray(
						[
							A2(
							...
							A2(
								...
								$elm$html$Html$Attributes$href(
									$author$project$Main$searchLink(kw.name)),
								$author$project$Main$inlineStyle),
							_List_fromArray(
								[
									$elm$html$Html$text(kw.name)
								])),
							A2(
							$elm$html$Html$span,
							_List_Nil,
							...
							_List_fromArray(
								[
									...
									_Utils_eq(kw.display, $author$project$Main$Show)),
									$elm$html$Html$Events$onClick(
									$author$project$Main$ClickedKeyword(kw.name))
								]),
							_List_Nil)
						])));
		};
		...
		var keywordLst = A2(
			...
			model.query,
			$author$project$Main$toList(model.keywordSet));
		var keywordCount = 'there are: ' + ($elm$core$String$fromInt(
			$elm$core$List$length(keywordLst)) + ' keywords.');
		var height = function (_v1) {
			var ws = _v1.a;
			return ws.height;
		}(
			$author$project$Main$getWindowSize(m));
					...
					[
							...
							A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$map,
										$author$project$Main$KeywordGraphMsg,
										$author$project$KeywordGraph$view(model.keywordGraph))
									])))),
						A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$el,
								_List_Nil,
								$mdgriffith$elm_ui$Element$text('This was generated on February 2nd, 2022.')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
								...
								$mdgriffith$elm_ui$Element$text('Keywords')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_Nil,
								$mdgriffith$elm_ui$Element$text(keywordCount)),
								$mdgriffith$elm_ui$Element$html(
								A2(
									$elm$html$Html$input,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$placeholder('Search for keyword'),
											$elm$html$Html$Attributes$value(model.query),
											$elm$html$Html$Events$onInput($author$project$Main$ChangedQuery)
										]),
									_List_Nil)),
								A2(
								$mdgriffith$elm_ui$Element$wrappedRow,
								_List_Nil,
								A2($elm$core$List$map, viewKeyword, keywordLst))
							]))
					])));
	}
};
