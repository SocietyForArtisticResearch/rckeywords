...
var $author$project$Main$emptyForm = {_abstract: '', after: $elm$core$Maybe$Nothing, author: '', before: $elm$core$Maybe$Nothing, keywords: _List_Nil, portal: '', title: ''};
													...
													return function (abstractWithKw) {
														return function (simpleToc) {
															return function (screenshots) {
																return {_abstract: _abstract, abstractWithKeywords: abstractWithKw, author: authr, created: created, createdDate: createdDate, defaultPage: defaultPage, id: id, issueId: issueId, keywords: keywords, portals: portals, publication: publication, publicationStatus: publicationStatus, screenshots: screenshots, thumbnail: thumbnail, title: title, toc: simpleToc};
															};
														};
													};
												};
...
var $author$project$Main$formWith = F7(
	function (title, author, keywords, _abstract, portal, after, before) {
		return {_abstract: _abstract, after: after, author: author, before: before, keywords: keywords, portal: portal, title: title};
	});
		...
		return _Utils_Tuple2(
			cmd,
			{
				form: $author$project$Main$AdvancedSearch(
					A7($author$project$Main$formWith, title, author, keywords, _abstract, portal, after, before)),
				layout: layout,
			...
			case 'ToggleAdvancedSearch':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							view: $author$project$Main$advancedSearchToggle(model.view)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var str = msg.a;
